...
function DocList({
  ...
  search: string
  onSelectDoc: (doc: Document) => void
  copy: { empty: string; emptySearch: string; loading: string }
}) {
      ...
      <>
        ...
        {isMobile && (
          <button
            ...
            aria-label={copy.expand}
            className="fixed right-4 bottom-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg transition-transform hover:scale-105 active:scale-95 md:hidden"
          >
        ...
        <div className="border-b border-border/50 p-2">
          <div className="relative">
            ...
            <input
              ...
              className="neo-input w-full bg-card py-1.5 pr-2 pl-8 text-xs"
            />
          </div>
        </div>
...
function MobileDocSheet({
  ...
  copy: { title: string; search: string; upload: string; empty: string; emptySearch: string; loading: string }
  onReload: () => void
}) {
