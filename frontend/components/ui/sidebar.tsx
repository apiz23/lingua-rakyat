      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r-2 group-data-[side=right]:border-l-2 group-data-[side=left]:border-r-foreground/20 group-data-[side=right]:border-l-foreground/20",
          className
        )}
        {...props}
      >
