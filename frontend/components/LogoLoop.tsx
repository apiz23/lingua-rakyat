              ...
              <>
                <div
                  ...
                  className={cx(
                    ...
                    "bg-[linear-linear(to_bottom,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_0%,rgba(0,0,0,0)_100%)]"
                  )}
                />
                <div
                  aria-hidden
                  className={cx(
                    ...
                    "h-[clamp(24px,8%,120px)]",
                    "bg-[linear-linear(to_top,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_0%,rgba(0,0,0,0)_100%)]"
                  )}
                />
              </>
            ) : (
              <>
                <div
                  ...
                  className={cx(
                    ...
                    "bg-[linear-linear(to_right,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_0%,rgba(0,0,0,0)_100%)]"
                  )}
                />
                <div
                  aria-hidden
                  className={cx(
                    ...
                    "w-[clamp(24px,8%,120px)]",
                    "bg-[linear-linear(to_left,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_0%,rgba(0,0,0,0)_100%)]"
                  )}
                />
              </>
            )}
